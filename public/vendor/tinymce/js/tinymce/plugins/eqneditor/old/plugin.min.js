...
tinymce.PluginManager.add("eqneditor",function(editor, url) {
	...
	var host='onesixx.com';

	//var http=('https:' == document.location.protocol ? 'https://' : 'http://');
	var http='http://';
	sl.add(http+host+'/wp-content/plugins/tinymce-advanced/mce/eqneditor/js/eq_config.js');
	sl.add(http+host+'/wp-content/plugins/tinymce-advanced/mce/eqneditor/js/eq_editor-lite-19.js');
	...
	fileref.setAttribute("href", http+host+'/wp-content/plugins/tinymce-advanced/mce/eqneditor/css/equation-embed.css');
			...
			items: [
				{
						...
						html:'<div style="padding:10px;"><div id="CCtoolbar'+CCinstance+'"></div>'+
								 '<p style="margin-top:5px"><label for="CClatex'+CCinstance+'">Equation <a href="http://s1.daumcdn.net/editor/fp/service_nc/pencil/Pencil_chromestore.html" target="_blank">(LaTeX)</a> :</p>'+
								 ...
								 '<img id="CCequation'+CCinstance+'" src="'+'http://onesixx.com/wp-content/plugins/tinymce-advanced/mce/eqneditor/img/spacer.gif" /></div>'
				}
			],
			buttons : [
					{
						type:'container',
						html:'<span style="font-size:11px;"><a href="https://www.codecogs.com/latex/about.php" target="_blank"  style="font-size:11px">About</a> | <a href="https://www.codecogs.com/latex/popup.php" target="_blank" style="font-size:11px">Install</a> | <a href="http://www.codecogs.com/pages/forums/forum_view.php?f=28" target="_blank" style="font-size:11px">Forum</a> | <a href="http://www.codecogs.com" target="_blank" style="font-size:11px">CodeCogs</a> &copy; 2007-2013</span>'
					},
					{type: "spacer", flex: 1},
					{
						text: 'Ok',
